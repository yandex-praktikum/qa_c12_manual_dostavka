"""
Fake-сервер, имитирующий API сервиса курьеров.
Автоматически поднимается при запуске тестов через conftest.py.
Не менять этот файл.
"""
...
_couriers = {
    1: {"id": 1, "first_name": "Иван", "last_name": "Петров", "phone": "+79991234567"},
    2: {"id": 2, "first_name": "Ольга", "last_name": "Смирнова", "phone": "+79997654321"},
}
_next_id = 3
